 ...
 * @version :   %G%
 */
public class EditCompetenceMenuItem extends EditPlanElementMenuItem {

    public EditCompetenceMenuItem(Stage stage, PlanElementNode planElementNode, GraphWindow graphWindow) {
    ...
    void initButtonAction(Stage stage, PlanElementNode planElementNode, GraphWindow graphWindow) {
        setOnAction(t -> Platform.runLater(() -> new EditCompetence(planElementNode, graphWindow)));
    }
}
